...
void MainWindow::initPortal(QString setting,int baudrate,QString parity){
    ...
    if(m_portal->m_flagOpenPort)setBaudDis(baudrate);
...
void MainWindow::quitPortal(){
    ...
    ui->baudDis->setText("-");
    ui->txIndicator->setText("-");
    ui->hzIndicator->setText("-");
    ui->modemTempIndicator->setText("-");
    ui->outputPowerIndicator->setText("-");
    ui->powerAmpTempIndicator->setText("-");
    ui->powerAmpStatusIndicator->setText("---");
